...
[TestClass]
public class DeleteWeatherForecastUseCaseTest : AutoMockSpecification<DeleteWeatherForecastUseCase, IDeleteWeatherForecastUseCase>
{
    ...
    protected override void GivenThat()
    {
        ...
        _eventDispatcher.Setup(x => x.Raise(It.IsAny<WeatherForecastDeletedEvent>()))
            .Returns(Task.CompletedTask);
    ...
    {
        var queueMessage = $"Publishing WeatherForecastDeletedEvent for {_testId}";
